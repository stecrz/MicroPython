...
class MCP23017:
    ...
    def __init__(self, i2c, address=0x20, def_inp=True, def_val=0):
        ...
        self.iodir = bytearray([def_inp * 0xFF] * MCP23017.GPIO_BYTES)  # default: all directions are outputs?
        self.gppu = bytearray([def_val * 0xFF] * MCP23017.GPIO_BYTES)   # default: all pullups enabled?
        self.gpio = bytearray([def_val * 0xFF] * MCP23017.GPIO_BYTES)   # default: all outputs high?
